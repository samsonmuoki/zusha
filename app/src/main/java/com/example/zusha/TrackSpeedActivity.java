...
//
//public class TrackSpeedActivity extends AppCompatActivity implements LocationListener, OnMapReadyCallback {
//
//    private static final String TAG = "TrackSpeedActivity";
//
...
//
//    private Button reportSpeedButton;
...
//
//        TextView regNoTextView2 = (TextView) findViewById(R.id.regNoTextView2);
//        TextView saccoTextView2 = (TextView) findViewById(R.id.saccoTextView2);
//        TextView driverTextView2 = (TextView) findViewById(R.id.driverTextView2);
//
//        final String regNoDetails2 = getIntent().getExtras().getString("regNoDetails");
//        final String saccoDetails2 = getIntent().getExtras().getString("saccoDetails");
//        final String driverDetails2 = getIntent().getExtras().getString("driverDetails");
//
//        regNoTextView2.setText(regNoDetails2);
//        saccoTextView2.setText(saccoDetails2);
//        driverTextView2.setText(driverDetails2);
//
...
//        });
//
//        reportSpeedButton = (Button) findViewById(R.id.reportSpeedButton);
//
...
//                reportSpeedButton.setOnClickListener(new View.OnClickListener() {
//                    @Override
//                    public void onClick(View v) {
//
...
//
//                        childRefRegNo.setValue(regNoDetails2);
//                        childRefDriver.setValue(driverDetails2);
//                        childRefSacco.setValue(saccoDetails2);
...
//                        Toast.makeText(TrackSpeedActivity.this, "Case successfully reported", Toast.LENGTH_SHORT).show();
//                    }
//                });
//
//            }
...
//
//        int available = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(TrackSpeedActivity.this);
//
...
//            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog(TrackSpeedActivity.this, available, ERROR_DIALOG_REQUEST);
//            dialog.show();
//        }
//        else{
...
//        TextView speedTextView2 = (TextView) this.findViewById(R.id.speedTextView2);
//        TextView speedStatusTextView2 = (TextView) this.findViewById(R.id.speedStatusTextView2);
//
...
//        if (location==null){
//
//            speedTextView2.setText("0");
//        } else {
//            float currentSpeed = location.getSpeed() * 3.6f;
//            speedTextView2.setText(String.format("%.2f", currentSpeed)+ "" );
//            if (currentSpeed > 25){
//                speedStatusTextView2.setText("Over Speeding");
...
//            } else {
//                speedStatusTextView2.setText("Below Limit");
//            }
//
//        }
//
